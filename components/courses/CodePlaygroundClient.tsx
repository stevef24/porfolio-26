...
function createSwissTheme(
	...
	return {
		...
		syntax: {
			...
			keyword: "oklch(0.53 0.14 125)",
			tag: "oklch(0.65 0.2 125)",
			punctuation: "oklch(0.556 0 0)",
			definition: "oklch(0.65 0.2 125)",
			property: "oklch(0.21 0.006 285.885)",
			static: "oklch(0.21 0.006 285.885)",
			string: "oklch(0.65 0.2 125)",
		},
		font: {
			...baseTheme.font,
			body: "var(--font-sans)",
