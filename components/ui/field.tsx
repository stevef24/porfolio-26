...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn("mb-2.5 font-medium data-[variant=label]:text-base data-[variant=legend]:text-base", className)}
      {...props}
    />
  )
}
...
function FieldTitle({
  ...
  return (
    <div
      data-slot="field-label"
      className={cn(
        "gap-2 text-base/relaxed group-data-[disabled=true]/field:opacity-50 flex w-fit items-center leading-snug",
        className
      )}
      {...props}
    />
...
function FieldDescription({
  ...
  return (
    <p
      ...
      className={cn(
        "text-muted-foreground text-left text-base/relaxed [[data-variant=legend]+&]:-mt-1.5 leading-normal font-normal group-has-[[data-orientation=horizontal]]/field:text-balance",
...
function FieldSeparator({
  ...
  return (
    <div
      ...
      className={cn("-my-2 h-6 text-base group-data-[variant=outline]/field-group:-mb-2 relative", className)}
      {...props}
    >
