    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          "data-[side=right]:rounded-l-[12px] data-[side=right]:border-l",
          ...
          "data-[side=left]:rounded-r-[12px] data-[side=left]:border-r",
          ...
          "data-[side=top]:rounded-b-[12px] data-[side=top]:border-b",
          ...
          "data-[side=bottom]:rounded-t-[12px] data-[side=bottom]:border-t",
