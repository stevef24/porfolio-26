...
function ComboboxItem({
  ...
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        "data-highlighted:bg-accent data-highlighted:text-accent-foreground not-data-[variant=destructive]:data-highlighted:**:text-accent-foreground gap-2 rounded-none py-2.5 pr-8 pl-3 text-base [&_svg:not([class*='size-'])]:size-4 relative flex w-full cursor-default items-center outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
      {...props}
    >
...
function ComboboxLabel({
  ...
  return (
    <ComboboxPrimitive.GroupLabel
      ...
      className={cn("text-muted-foreground px-3 py-2.5 text-base", className)}
      {...props}
    />
  )
}
...
function ComboboxEmpty({
  ...
  return (
    <ComboboxPrimitive.Empty
      ...
      className={cn("text-muted-foreground hidden w-full justify-center py-2.5 text-center text-base group-data-empty/combobox-content:flex", className)}
      {...props}
    />
  )
}
...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn("dark:bg-input/30 border-input focus-within:border-ring focus-within:ring-ring/50 has-aria-invalid:ring-destructive/20 dark:has-aria-invalid:ring-destructive/40 has-aria-invalid:border-destructive dark:has-aria-invalid:border-destructive/50 flex min-h-10 flex-wrap items-center gap-1.5 rounded-none border bg-transparent bg-clip-padding px-3 py-2 text-base transition-colors focus-within:ring-1 has-aria-invalid:ring-1 has-data-[slot=combobox-chip]:px-1.5", className)}
      {...props}
    />
  )
}
...
function ComboboxChip({
  ...
  return (
    <ComboboxPrimitive.Chip
      ...
      className={cn(
        "bg-muted text-foreground flex h-8 w-fit items-center justify-center gap-1 rounded-none px-2 text-base font-medium whitespace-nowrap has-data-[slot=combobox-chip-remove]:pr-0 has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50",
        className
      )}
      {...props}
    >
