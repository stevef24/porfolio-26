 ...
 * it updates the context's activeIndex. The active step is shown at full
 * opacity with a subtle shift, while inactive steps are faded.
 *
 * @example
 * ```tsx
	...
	return (
		<motion.div
			...
			className={cn(
				...
				"md:min-h-[18vh]", // Desktop: smaller height for compact feel
				"py-4 md:py-0", // Mobile: padding instead of min-height
