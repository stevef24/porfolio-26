    ...
    <>
      ...
      <SiteShell>
        <article className="relative py-16 lg:py-24">
          ...
          <Link
            href="/blog"
            className="inline-flex items-center gap-1.5 text-swiss-label hover:text-primary transition-colors mb-12"
          >
            <svg
          ...
          <header className="mb-16">
            <h1 className="text-swiss-hero mb-6">
              {page.data.title}
            </h1>
