...
The model decides <Annotate type="highlight" color="oklch(0.93 0.08 95 / 0.35)" padding={4}>what to do</Annotate>.
The runtime decides <Annotate type="highlight" color="oklch(0.93 0.08 95 / 0.35)" padding={4}>what is possible</Annotate>.
